...
const operatorOptions: FilterTypeaheadOption<ReturnFilterOperator>[] = [
...
const valueTypeOptions: FilterTypeaheadOption<ReturnValueType>[] = [
          ...
          >
            ...
            >
              <FilterTypeaheadSelect
                ...
                onChange={(operator) => changeReturnOperator(index, operator)}
                size="small"
                sx={{ flex: '0 1 170px' }}
              />
            </Tooltip>
